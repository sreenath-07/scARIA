...
server <- function(input, output) {
  ...
  observeEvent(input$integrateupload_btn, {
    ...
    {showModal(modalDialog(
      ...
      ##ATAC Pipeline
      print("hello")
      tempfragpath<-"C:/Users/varsh/Desktop/GT Research/BIOL 8803/ATAC_dummy"
      file.copy(input$atacfrag$datapath, paste0(tempfragpath, "/fragments.tsv.gz"))
      file.copy(input$atacindex$datapath, paste0(tempfragpath, "/fragments.tsv.gz.tbi"))
      ...
      chrom_assay <- CreateChromatinAssay(
        ...
        sep = c(":", "-"),
        genome = 'hg19',
        fragments = "C:/Users/varsh/Desktop/GT Research/BIOL 8803/ATAC_dummy/fragments.tsv.gz",
        min.cells = 10,
        min.features = 200
      )
